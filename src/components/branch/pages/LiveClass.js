...
const LiveClass = React.memo((props) => {
  ...
  const updateSubmitHandler = (evt) => {
    ...
    fetch(Config.SERVER_URL + "/branch/updateMeeting", {
      method: "PUT",
  ...
  const deleteSubmitHandler = () => {
    ...
    fetch(Config.SERVER_URL + "/branch/deleteMeeting", {
      method: "DELETE",
      body: JSON.stringify(meetingData),
      headers: {
        "Content-Type": "application/json",
  ...
  const submitHandler = (evt) => {
    ...
    fetch(Config.SERVER_URL + "/branch/createMeeting", {
      method: "POST",
  ...
  useEffect(() => {
    fetch(Config.SERVER_URL + "/branch/searchMeeting?session=" + localStorage.getItem("branchSession"), {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("jwt_branch_token")}`,
    ...
    // Get All Batches
    fetch(Config.SERVER_URL + "/branch/searchBatch?session=" + localStorage.getItem("branchSession"), {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("jwt_branch_token")}`,
