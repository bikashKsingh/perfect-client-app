...
const OnlineTest = React.memo((props) => {
  ...
  const updateSubmitHandler = (evt) => {
    ...
    fetch(Config.SERVER_URL + "/branch/updateOnlineTest", {
      method: "PUT",
  ...
  const deleteSubmitHandler = () => {
    ...
    fetch(Config.SERVER_URL + "/branch/deleteOnlineTest", {
      method: "DELETE",
  ...
  const submitHandler = (evt) => {
    ...
    fetch(Config.SERVER_URL + "/branch/addOnlineTest", {
      method: "POST",
  ...
  const setTestToLocalstorage = (evt, data) => {
    fetch(Config.SERVER_URL + "/branch/searchOnlineTest?session=" + selectedSession + "&_id=" + data._id, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("jwt_branch_token")}`,
      ...
      .then(
        (result) => {
          ...
          if (result.success) {
            ...
            history.push("/branch/addQuestionToOnlineTest");
        ...
        return (
          <div>
            ...
            <Link
              ...
              to={`/branch/onlineTestDetails/${row.original._id}`}
            >
              <span
