...
const Assignments = React.memo ((props) => {
  ...
  const deleteSubmitHandler = async () => {
    ...
    fetch(Config.SERVER_URL + "/branch/deleteAssignment", {
      method: "DELETE",
  ...
  const submitHandler = (evt) => {
    ...
    fetch(Config.SERVER_URL + "/branch/addAssignment", {
      method: "POST",
  ...
  useEffect(() => {
    ...
    fetch(Config.SERVER_URL + "/branch/searchAssignment?session="+selectedSession, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("jwt_branch_token")}`,
