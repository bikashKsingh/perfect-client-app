...
const FormulaCharts = React.memo((props) => {
  ...
  const deleteSubmitHandler = async () => {
    ...
    fetch(Config.SERVER_URL + "/branch/deleteFormulaChart", {
      method: "DELETE",
  ...
  const submitHandler = (evt) => {
    ...
    fetch(Config.SERVER_URL + "/branch/addFormulaChart", {
      method: "POST",
  ...
  useEffect(() => {
    ...
    fetch(Config.SERVER_URL + "/branch/searchFormulaChart?session=" + selectedSession, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("jwt_branch_token")}`,
