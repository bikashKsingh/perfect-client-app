...
const Video = React.memo((props) => {
  ...
  const updateSubmitHandler = (evt) => {
    ...
    evt.preventDefault();
    fetch(Config.SERVER_URL + "/branch/updateVideo", {
      method: "PUT",
  ...
  const deleteSubmitHandler = () => {
    ...
    fetch(Config.SERVER_URL + "/branch/deleteVideo", {
      method: "DELETE",
  ...
  const submitHandler = (evt) => {
    ...
    fetch(Config.SERVER_URL + "/branch/addVideo", {
      method: "POST",
  ...
  useEffect(() => {
    ...
    fetch(Config.SERVER_URL + "/branch/searchVideo?session=" + selectedSession, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("jwt_branch_token")}`,
    ...
    // Search Chapters
    fetch(Config.SERVER_URL + "/branch/searchChapter?session=" + selectedSession, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("jwt_branch_token")}`,
    ...
    // Get All CouyseType
    fetch(Config.SERVER_URL + "/branch/searchCourseType?session=" + selectedSession, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("jwt_branch_token")}`,
        ...
        return (
          <div>
            <button
              ...
              onClick={() => {
                updateState(row.row.original, "update");
              }}
            >
              <span
            ...
            <button
              ...
              onClick={(evt) => setShowData(JSON.parse(JSON.stringify(row.row.original)))}
            >
              <span
            ...
            <button
              ...
              onClick={(evt) => setDeleteId({ _id: row.row.original._id, notes_file: row.row.original.notes_file || "" })}
            >
              <span
