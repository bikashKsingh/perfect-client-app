                ...
                <div className={"col-md-3"}>
                  <div className={"card mb-0 mt-2 border-0 rounded-0"}>
                    ...
                    <div className={"card-body pb-0 pt-2 px-0"} style={{ height: "285px", overflowY: "scroll" }}>
                      ...
                      <div className="px-2">
                        <input checked={formData.staff.showPersonalStaffDetails ? "checked" : null} type="checkbox" className="" id="showPersonalStaffDetails" name={"showPersonalStaffDetails"}
                          onClick={(evt) => clickHandler(evt, "staff")}
                        />
                        <label className="" for="showPersonalStaffDetails">Show Personal Staff Details</label>
                      </div>
                ...
                <div className={"col-md-3"}>
                  <div className={"card mb-0 mt-2 border-0 rounded-0"}>
                    ...
                    <div className={"card-body pb-0 pt-2 px-0"} style={{ height: "285px", overflowY: "scroll" }}>
                      ...
                      <div className="px-2">
                        <input checked={formData.onlineTest.addQuestionToTest ? "checked" : null} type="checkbox" className="" id="addQuestionToTest" name={"addQuestionToTest"}
                          onClick={(evt) => clickHandler(evt, "onlineTest")}
                        />
                        <label className="" for="addQuestionToTest">Add Question To Test</label>
                      </div>

                      <div className="px-2">
                        <input checked={formData.onlineTest.showSingleTestDetails ? "checked" : null} type="checkbox" className="" id="showSingleTestDetails" name={"showSingleTestDetails"}
                          onClick={(evt) => clickHandler(evt, "onlineTest")}
                        />
                        <label className="" for="showSingleTestDetails">Show Single Test Details</label>
                      </div>

                      <div className="px-2">
                        <input checked={formData.onlineTest.showSingleQuestionDetails ? "checked" : null} type="checkbox" className="" id="showSingleQuestionDetails" name={"showSingleQuestionDetails"}
                          onClick={(evt) => clickHandler(evt, "onlineTest")}
                        />
                        <label className="" for="showSingleQuestionDetails">Show Single Question Details</label>
                      </div>
                ...
                <div className={"col-md-3"}>
                  <div className={"card mb-0 mt-2 border-0 rounded-0"}>
                    ...
                    <div className={"card-body pb-0 pt-2 px-0"} style={{ height: "285px", overflowY: "scroll" }}>
                      ...
                      <div className="px-2">
                        <input checked={formData.video.showSingleVideoDetails ? "checked" : null} type="checkbox" className="" id="showSingleVideoDetails" name={"showSingleVideoDetails"}
                          onClick={(evt) => clickHandler(evt, "video")}
                        />
                        <label className="" for="showSingleVideoDetails">Show Single Video Details</label>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className={"col-md-3"}>
                  <div className={"card mb-0 mt-2 border-0 rounded-0"}>
                    ...
                    <div className={"card-body pb-0 pt-2 px-0"} style={{ height: "285px", overflowY: "scroll" }}>
                      ...
                      <div className="px-2">
                        <input checked={formData.classRoomAsset.showSingleChapterLayout ? "checked" : null} type="checkbox" className="" id="showSingleChapterLayout" name={"showSingleChapterLayout"}
                          onClick={(evt) => clickHandler(evt, "classRoomAsset")}
                        />
                        <label className="" for="showSingleChapterLayout">Show Single ChapterLayout Details</label>
                      </div>
                      ...
                      <div className="px-2">
                        <input checked={formData.classRoomAsset.showSingleFormulaChart ? "checked" : null} type="checkbox" className="" id="showSingleFormulaChart" name={"showSingleFormulaChart"}
                          onClick={(evt) => clickHandler(evt, "classRoomAsset")}
                        />
                        <label className="" for="showSingleFormulaChart">Show Single Formula Chart</label>
                      </div>
                      ...
                      <div className="px-2">
                        <input checked={formData.classRoomAsset.showSingleAssignment ? "checked" : null} type="checkbox" className="" id="showSingleAssignment" name={"showSingleAssignment"}
                          onClick={(evt) => clickHandler(evt, "classRoomAsset")}
                        />
                        <label className="" for="showSingleAssignment">Show Single Assignment</label>
                      </div>
                    </div>
                  </div>
                </div>
