...
const ChapterLayouts = React.memo ((props) => {
  ...
  const deleteSubmitHandler = async () => {
    ...
    fetch(Config.SERVER_URL + "/branch/deleteChapterLayout", {
      method: "DELETE",
  ...
  const submitHandler = (evt) => {
    ...
    fetch(Config.SERVER_URL + "/branch/addChapterLayout", {
      method: "POST",
  ...
  useEffect(() => {
    ...
    fetch(Config.SERVER_URL + "/branch/searchChapterLayout?session="+selectedSession, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("jwt_branch_token")}`,
  ...
  const getChapters = (evt) => {
    ...
    // Get All Chapter
    fetch(Config.SERVER_URL+"/branch/searchChapter?session="+selectedSession+"&course_type=" +
    evt.target.value, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
  ...
  const getBatches = (std, cType) => {
    // Get All Batch
    fetch(Config.SERVER_URL+"/branch/searchBatch?session="+selectedSession+"&standard="+std+"&course_type="+cType, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("jwt_branch_token")}`,
        ...
        return(
          <div>
            ...
            <button
              ...
              onClick={(evt) => setDeleteId(row.row.original)}
            >
              <span
