...
const Routing = () => {
  ...
  return (
    <Switch>
      ...
      <Route exact path="/studentForgotPassword" component={StudentForgotPassword} />
      ...
      <Route exact path="/studentCreateNewPassword" component={StudentCreateNewPassword} />
      <Route exact path="/studentRegistration" component={StudentRegistration} />
      <Route exact path="/studentEnterRegistrationOTP" component={StudentEnterRegistrationOTP} />
